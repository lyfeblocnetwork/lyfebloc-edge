...
import (
	...
	"github.com/lyfeblocnetwork/lyfebloc-edge/e2e/framework"
	...
	txpoolOp "github.com/lyfeblocnetwork/lyfebloc-edge/txpool/proto"
	...
	ibftManager := framework.NewIBFTServersManager(
		...
		func(i int, config *framework.TestServerConfig) {
			if i < numGenesisValidators {
				...
				dirPrefix := "lyfebloc-edge-non-validator-"
